...
CustomButton::CustomButton(Parameter* param, String label) : ParameterEditor(param)
{
    ...
    button->setFont(FontOptions("Fira Code", "Regular", 12.0f));
    ...
    : VisualizerEditor(parentNode, "Crossing Detector", 205)
{
    ...
    getParameterEditor("Channel")->setLayout(ParameterEditor::nameOnRight);

    addComboBoxParameterEditor(Parameter::STREAM_SCOPE, "TTL_OUT", 15, 45); 
    getParameterEditor("TTL_OUT")->setLayout(ParameterEditor::nameOnRight);
    ...
    acrossLabel = createLabel("AcrossL", "THRESHOLD:", { 107, 65, 100, 18 });
    ...
    juce::Rectangle<int> bounds)
{
    ...
    label->setFont(Font("Fira Code", "Regular", 12));
